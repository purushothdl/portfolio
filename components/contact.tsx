...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 backdrop-blur-sm bg-white/30 dark:bg-gray-900/30 rounded-3xl border border-gray-200 dark:border-gray-800/50 p-8 sm:p-12 shadow-xl overflow-hidden">
        {/* Floating decorative elements */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-10 left-10 w-20 h-20 border border-gray-200 dark:border-gray-700/30 rounded-full"></div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            className="backdrop-blur-md bg-white/80 dark:bg-gray-800/80 rounded-2xl border border-gray-200 dark:border-gray-700/50 p-6 shadow-lg"
          >
          ...
          >
            ...
            {[
              ...
              <motion.a
                ...
                className="group flex flex-col items-center justify-center gap-3 p-5 bg-white/80 dark:bg-gray-800/80 rounded-xl border border-gray-200 dark:border-gray-700/50 hover:border-blue-400 dark:hover:border-blue-500/50 shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
              >
                <div className={`p-3 bg-${social.color}-100 dark:bg-${social.color}-900/30 rounded-lg group-hover:bg-${social.color}-200 dark:group-hover:bg-${social.color}-800/30 transition-colors`}>
                  <social.icon className={`text-2xl text-${social.color}-600 dark:text-${social.color}-400`} />
                </div>
            ...
            <motion.div
              ...
              className="relative p-6 rounded-xl overflow-hidden shadow-lg"
            >
